...
def create_teacher(db: Session, teacher: schemas.TeacherCreate):
    ...
    db_teacher = model.Teacher(firstname=teacher.firstname,lastname=teacher.lastname,username=teacher.username ,hashedpassword=bcrypt.hash(teacherid.password))
    db.add(db_teacher)
    db.commit()
